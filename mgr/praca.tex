...
\newcommandx{\change}[2][1=]{\todo[inline,linecolor=red,backgroundcolor=white,bordercolor=red,#1]{#2}}
...
\shortauthor{Karol Patryk Kozak}
\titlePL{Implementacja zaawansowanego silnika fizyki wspierającego deformacje obiektów}

% Skrócone wersje tytułów po polsku/angielsku
% wyświetlane np. gdy normalne są bardzo długie
\shorttitlePL{Implementacja zaawansowanego silnika fizyki...}

% Rodzaj pracy
\thesistype{Praca dyplomowa magisterska}

% Opiekun pracy
\supervisor{dr inż. Joanna Świebocka-Więk}
